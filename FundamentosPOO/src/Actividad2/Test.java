...
public class Test {
	...
	Computadora compu1= new Computadora(" Hibeeme ",Tipo.DESKTOP,miProcesador);
	Computadora compu2= new Computadora("Azuz",Tipo.LAPTOP,miProcesador,miLectoraDVD);// Invoca al constructor que tiene grabadora de DVD
